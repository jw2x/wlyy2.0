...
$(function () {
    table = $("#list").DataTable({
            ...
            "ajax": {
                url: server+ '/version//wlyyVersion/list',
                data: function (d) {
                    d.name = $("#name").val();
                    d.saasId = saasId;
                    d.userCode = userCode;
            ...
            "aoColumns": [
                ...
                },
                {
                    ...
                    "sWidth": "10%",
                    "render": function (data, type, full, meta) {
                        return data = '<button class="btn btn-primary  btn-sm" data-id=' + data + ' onclick="show(\'' + data + '\')">查 看</button>';
...
function show(code) {
    ...
    var data = {};
    do_get(server+"/version/wlyyVersion/"+code, data, function (data) {
        debugger
...
function del(codes) {
    var url = server+"/version/wlyyVersion/" + codes ;
...
$("#category_add").submit(function(){
    var url = server+"/version/wlyyVersion";
    var id = $("#id").val();
