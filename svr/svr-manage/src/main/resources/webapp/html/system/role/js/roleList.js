    ...
    table = $("#list").DataTable({
            ...
            "aoColumns": [
                ...
                },
                {
                    ...
                    "sWidth": "10%",
                    "render": function (data, type, full, meta) {
                        return data = '<button class="btn btn-primary  btn-sm" style="margin-right:5px" data-id=' + data + ' onclick="menuRole(\''+data+'\')">权限配置</button>' +
                            '<button class="btn btn-primary  btn-sm" style="margin-right:5px" data-id=' + data + ' onclick="userRole(\''+data+'\')">人员配置</button>' +
                            '<button class="btn btn-primary  btn-sm" style="margin-right:5px" data-id=' + data + ' onclick="show(\''+data+'\')">查 看</button>';
                    }
                }
            ],
            "columnDefs": [{
...
function show(code){
    ...
    var data={};
    do_get(server+"/manage/role/"+code,data,function(data){
...
function del(codes){
    var url = server+"/manage/role/"+codes;
...
function userRole(code){
    $("#myModalDialog").css("width","650px");
    $("#myModal").attr("data-code",code);
    $("#myModal").modal({
        remote: "userRole.html",
        show:true
    });
}

function menuRole(code){
    $("#myModal").attr("data-code",code);
    $("#myModalDialog").css("width","250px");
    $("#myModal").modal({
        remote: "menuRole.html",
        show:true
    });
}