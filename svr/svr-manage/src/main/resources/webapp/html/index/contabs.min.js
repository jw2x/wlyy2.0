$(function() {
    ...
    $(".J_menuItem").each(function(t) {
        ...
        $(document.body).on("click",".J_menuItem", n)
            .on("click", ".J_menuTab i", s)
            .on("click",'.J_tabCloseOther', r)
            .on("click",".J_tabShowActive", o)
            .on("click", ".J_menuTabs .J_menuTab", d)
            .on("dblclick", "J_menuTabs .J_menuTab", c)
            .on("click",'J_tabLeft', a)
            .on("click",'.J_tabRight', i)
            .on("click",'.J_tabCloseAll', function() {
