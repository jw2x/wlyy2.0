...
public class IotDeviceLabelInfoController extends EnvelopRestEndpoint {
    ...
    public MixEnvelop queryPage(
        ...
        return MixEnvelop.getSuccessListWithPage(IotRequestMapping.DeviceLabelInfo.message_success_find_functions,iotDeviceLabelInfos, page, size,count);
    }
    ...
    public MixEnvelop getList(
        ...
        //封装返回格式
        List<IotDeviceLabelInfoDO> iotDeviceLabelInfos = convertToModels(list, new ArrayList<>(list.size()), IotDeviceLabelInfoDO.class, fields);
        return MixEnvelop.getSuccessList(IotRequestMapping.DeviceLabelInfo.message_success_find_functions,iotDeviceLabelInfos);
    }
}
