...
public interface UserUrlVersionFegin {
    ...
    @PostMapping(value = BaseVersionContants.UserUrlVersion.api_create,consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    Envelop create(@RequestBody String jsonData) throws JiWeiException;

    @PutMapping(value =  BaseVersionContants.UserUrlVersion.api_update,consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    Envelop update(@RequestBody String jsonData) throws JiWeiException;

    @DeleteMapping(value =BaseVersionContants.UserUrlVersion.api_delete)
    ...
    @GetMapping(value = BaseVersionContants.UserUrlVersion.api_getByCode)
    Envelop findByCode(@PathVariable(required = true, value = "code") String code) throws JiWeiException;

    @RequestMapping(value = BaseVersionContants.UserUrlVersion.api_getList, method = RequestMethod.GET)
    Envelop getList(
